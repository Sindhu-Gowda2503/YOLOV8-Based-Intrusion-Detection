  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className={cn("text-neutral-700 dark:text-neutral-200 text-sm whitespace-pre inline-block !p-0 !m-0", {
          "group-hover/sidebar:translate-x-1 transition duration-150": !className?.includes("border"),
        })}
      >
        {link.label}
      </motion.span>
